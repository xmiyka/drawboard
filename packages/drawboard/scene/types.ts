import type { UserIdleState, EditorInterface } from "@drawboard/common";
import type {
  DrawboardElement,
...
export type StaticCanvasRenderConfig = {
  ...
  pendingFlowchartNodes: PendingDrawboardElements | null;
...
export type InteractiveCanvasRenderConfig = {
  ...
  // ---------------------------------------------------------------------------
  remoteSelectedElementIds: Map<DrawboardElement["id"], SocketId[]>;
...
export type StaticSceneRenderConfig = {
  ...
  visibleElements: readonly NonDeletedDrawboardElement[];
  scale: number;
...
export type NewElementSceneRenderConfig = {
  canvas: HTMLCanvasElement | null;
  rc: RoughCanvas;
  newElement: DrawboardElement | null;
  elementsMap: RenderableElementsMap;
  allElementsMap: NonDeletedSceneElementsMap;
  scale: number;
  appState: AppState;
