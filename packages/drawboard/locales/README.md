...
- to request a new translation, [open an issue](https://github.com/drawboard/drawboard/issues/new/choose).
- to update existing translations, [edit them on Crowdin](https://crowdin.com/translate/drawboard/10) and we should have them included in the app soon!
