...
import { getTextWidth } from "@drawboard/element";
import { normalizeText } from "@drawboard/element";
...
export const textWysiwyg = ({
  ...
  drawboardContainer: HTMLDivElement | null;
  app: App;
  autoSelect?: boolean;
}): SubmitHandler => {
  const textPropertiesUpdated = (
    updatedTextElement: DrawboardTextElement,
  ...
  const updateWysiwygStyle = () => {
    ...
    const updatedTextElement = app.scene.getElement<DrawboardTextElement>(id);
        ...
        if (isArrowElement(container)) {
          const boundTextCoords =
            LinearElementEditor.getBoundTextElementPosition(
              container,
              updatedTextElement as DrawboardTextElementWithContainer,
              elementsMap,
            );
  ...
  editable.wrap = "off";
  editable.classList.add("drawboard-wysiwyg");
      ...
      if (editable.value.trim()) {
        ...
        app.scene.mutateElement(container, {
          boundElements: container.boundElements?.filter(
            (ele) =>
              !isTextElement(
                ele as DrawboardTextElement | DrawboardLinearElement,
              ),
          ),
        });
      }
  ...
  drawboardContainer
    ?.querySelector(".drawboard-textEditorContainer")!
