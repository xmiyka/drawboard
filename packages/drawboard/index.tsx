...
import { DEFAULT_UI_OPTIONS, isShallowEqual } from "@drawboard/common";
...
import type { AppProps, DrawboardProps } from "./types";

polyfill();

const DrawboardBase = (props: DrawboardProps) => {
  const {
    onChange,
    onIncrement,
    initialData,
...
const areEqual = (prevProps: DrawboardProps, nextProps: DrawboardProps) => {
  // short-circuit early
...
export const Drawboard = React.memo(DrawboardBase, areEqual);
...
export { getTextFromElements } from "@drawboard/element";
export { isInvisiblySmallElement } from "@drawboard/element";
...
export { isLinearElement } from "@drawboard/element";
...
export { mutateElement, newElementWith, bumpVersion } from "@drawboard/element";

export { CaptureUpdateAction } from "@drawboard/element";
...
} from "@drawboard/utils/withinBounds";

export { DiagramToCodePlugin } from "./components/DiagramToCodePlugin/DiagramToCodePlugin";
export { getDataURL } from "./data/blob";
export { isElementLink } from "@drawboard/element";

export { setCustomTextMetricsProvider } from "@drawboard/element";
