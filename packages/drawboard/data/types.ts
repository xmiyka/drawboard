import type { VERSIONS } from "@drawboard/common";
...
export interface ImportedDataState {
  ...
  version?: number;
  source?: string;
  elements?: readonly DrawboardElement[] | null;
  appState?: Readonly<
    Partial<
      AppState & {
...
export interface ExportedLibraryData {
  type: string;
  version: typeof VERSIONS.drawboardLibrary;
  source: string;
...
export type DrawboardLibraryIds = {
