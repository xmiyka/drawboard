...
import { getElementsOverlappingFrame } from "@drawboard/element";
...
export type ExportedElements = readonly NonDeletedDrawboardElement[] & {
...
export const prepareElementsForExport = (
  ...
  let exportingFrame: DrawboardFrameLikeElement | null = null;
...
export const exportCanvas = async (
    ...
    if (type === "svg") {
      return fileSave(
        ...
        }),
        {
          ...
          name,
          extension: appState.exportEmbedScene ? "drawboard.svg" : "svg",
  ...
  if (type === "png") {
    ...
    return fileSave(blob, {
      ...
      name,
      extension: appState.exportEmbedScene ? "drawboard.png" : "png",
