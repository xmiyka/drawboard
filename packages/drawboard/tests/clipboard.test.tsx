...
import { KEYS, arrayToMap, getLineHeight } from "@drawboard/common";
...
vi.mock("@drawboard/common", async (importOriginal) => {
...
describe("Paste bound text container", () => {
  ...
  const textElement = {
    ...
    originalText:
      "Drawboard is a virtual opensource whiteboard for sketching hand-drawn like diagrams",
  };

  it("should fix ellipse bounding box", async () => {
    const data = JSON.stringify({
      type: "drawboard/clipboard",
