import { arrayToMap, easeOut, THEME } from "@drawboard/common";
...
import { shouldTestInside } from "@drawboard/element";
import { hasBoundTextElement, isBoundToContainer } from "@drawboard/element";
import { getBoundTextElementId } from "@drawboard/element";

import { AnimatedTrail } from "../animated-trail";

import type { Bounds } from "@drawboard/common";

import type { GlobalPoint, LineSegment } from "@drawboard/math/types";
...
export class EraserTrail extends AnimatedTrail {
  private elementsToErase: Set<DrawboardElement["id"]> = new Set();
  private groupsToErase: Set<DrawboardElement["id"]> = new Set();
