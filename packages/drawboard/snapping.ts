...
import { TOOL_TYPE, KEYS } from "@drawboard/common";
import {
  getCommonBounds,
  getDraggedElementsBounds,
  getElementAbsoluteCoords,
} from "@drawboard/element";
import { isBoundToContainer } from "@drawboard/element";

import { getMaximumGroups } from "@drawboard/element";
...
import type { InclusiveRange } from "@drawboard/math";
...
export const getVisibleGaps = (
  ...
  const referenceElements: DrawboardElement[] = getReferenceElements(
    elements,
    selectedElements,
    appState,
    elementsMap,
...
export const snapResizingElements = (
  ...
  selectedOriginalElements: DrawboardElement[],
  app: AppClassProperties,
  event: KeyboardModifiersObject,
  dragOffset: Vector2D,
