...
import { MIME_TYPES, arrayToMap, nextAnimationFrame } from "@drawboard/common";

import { duplicateElements } from "@drawboard/element";
...
export default function LibraryMenuItems({
  ...
  const onItemDrag = useCallback(
    (id: LibraryItem["id"], event: React.DragEvent) => {
      ...
      const data: DrawboardLibraryIds = {
