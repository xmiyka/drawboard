...
import { isDarwin, isFirefox, isWindows } from "@drawboard/common";
...
const Header = () => (
  <div className="HelpDialog__header">
    ...
    <a
      className="HelpDialog__btn"
      href="https://github.com/drawboard/drawboard/issues"
      target="_blank"
    ...
    <a
      className="HelpDialog__btn"
      href="https://youtube.com/@drawboard"
      target="_blank"
      rel="noopener noreferrer"
    >
