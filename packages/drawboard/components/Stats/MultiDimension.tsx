...
import { MIN_WIDTH_OR_HEIGHT } from "@drawboard/common";
import {
...
import { getBoundTextElement, handleBindTextResize } from "@drawboard/element";

import { isTextElement } from "@drawboard/element";

import { getCommonBounds } from "@drawboard/utils";
...
const resizeGroup = (
  ...
  anchor: GlobalPoint,
  property: MultiDimensionProps["property"],
  latestElements: DrawboardElement[],
  originalElements: DrawboardElement[],
  originalElementsMap: ElementsMap,
  scene: Scene,
) => {
...
> = ({
  ...
  const elementsToHighlight: DrawboardElement[] = [];
