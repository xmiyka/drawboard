import { round } from "@drawboard/math";
import clsx from "clsx";
import throttle from "lodash.throttle";
import { useEffect, useMemo, useState, memo } from "react";

import { STATS_PANELS } from "@drawboard/common";
import { getCommonBounds } from "@drawboard/element";
import { getUncroppedWidthAndHeight } from "@drawboard/element";
import { isImageElement } from "@drawboard/element";

import { frameAndChildrenSelectedTogether } from "@drawboard/element";

import { elementsAreInSameGroup } from "@drawboard/element";

import { t } from "../../i18n";
import { isGridModeEnabled } from "../../snapping";
import { useDrawboardAppState, useDrawboardSetAppState } from "../App";
...
import type { NonDeletedDrawboardElement } from "@drawboard/element/types";
import type { AppClassProperties, AppState, DrawboardProps } from "../../types";

interface StatsProps {
  app: AppClassProperties;
  onClose: () => void;
  renderCustomStats: DrawboardProps["renderCustomStats"];
}
...
export const StatsInner = memo(
  ({
    ...
    const throttledSetSceneDimension = useMemo(
      () =>
        throttle((elements: readonly NonDeletedDrawboardElement[]) => {
