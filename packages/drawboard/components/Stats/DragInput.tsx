...
import { EVENT, KEYS, cloneJSON } from "@drawboard/common";
...
> = (props: {
  ...
  setAppState: ReturnType<typeof useDrawboardSetAppState>;
}) => void;

export type DragFinishedCallbackType<E = DrawboardElement> = (props: {
  app: ReturnType<typeof useApp>;
  setAppState: ReturnType<typeof useDrawboardSetAppState>;
...
const StatsDragInput = <
  T extends StatsInputProperty,
  E extends DrawboardElement = DrawboardElement,
>({
  label,
  icon,
  dragInputCallback,
      ...
      <div
        ...
        onPointerDown={(event) => {
          if (inputRef.current && editable) {
            document.body.classList.add("drawboard-cursor-resize");
            ...
            const onPointerUp = () => {
              ...
              document.body.classList.remove("drawboard-cursor-resize");
