...
import { EDITOR_LS_KEYS, debounce, isDevEnv } from "@drawboard/common";
...
const MermaidToExcalidraw = ({
  ...
  const [text, setText] = useState(
    () =>
      EditorLocalStorage.get<string>(EDITOR_LS_KEYS.MERMAID_TO_DRAWBOARD) ||
      MERMAID_EXAMPLE,
  );
  ...
  }, [deferredText, mermaidToDrawboardLib, isActive, theme]);
