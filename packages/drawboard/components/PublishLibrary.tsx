import { exportToCanvas, exportToSvg } from "@drawboard/utils/export";
...
const PublishLibrary = ({
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("drawboardLib", lib);
        ...
        <form onSubmit={onSubmit}>
          <div className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://libraries.drawboard.com"
                  target="_blank"
                  rel="noopener"
                >
                  {el}
          ...
          <span className="publish-library-note">
            <Trans
              ...
              link={(el) => (
                <a
                  href="https://github.com/drawboard/drawboard-libraries#guidelines"
                  target="_blank"
          ...
          <div className="publish-library__fields">
            ...
            <span className="publish-library-note">
              <Trans
                ...
                link={(el) => (
                  <a
                    href="https://github.com/drawboard/drawboard-libraries/blob/main/LICENSE"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    {el}
