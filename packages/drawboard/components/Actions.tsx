...
export const canChangeStrokeColor = (
  appState: UIAppState,
  targetElements: DrawboardElement[],
) => {
  let commonSelectedType: DrawboardElementType | null =
...
export const CompactShapeActions = ({
  ...
  const targetElements = getTargetElements(elementsMap, appState);
  const { container } = useDrawboardContainer();
