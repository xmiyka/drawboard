...
import type { ElementsSegmentsMap, GlobalPoint } from "@drawboard/math/types";
...
export const getLassoSelectedElementIds = (input: {
  ...
  intersectedElements: Set<DrawboardElement["id"]>;
  enclosedElements: Set<DrawboardElement["id"]>;
