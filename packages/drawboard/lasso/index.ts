import { type GlobalPoint, type LineSegment, pointFrom } from "@drawboard/math";

import { getElementLineSegments } from "@drawboard/element";
...
export class LassoTrail extends AnimatedTrail {
  private intersectedElements: Set<DrawboardElement["id"]> = new Set();
  private enclosedElements: Set<DrawboardElement["id"]> = new Set();
