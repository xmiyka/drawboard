...
import { charWidth } from "@drawboard/element";
import { containsCJK } from "@drawboard/element";
...
export class Fonts {
  ...
  private static async loadFontFaces(
    fontFamilies: Array<DrawboardTextElement["fontFamily"]>,
  ...
  private static getUniqueFamilies(
    elements: ReadonlyArray<DrawboardElement>,
  ): Array<DrawboardTextElement["fontFamily"]> {
    return Array.from(
