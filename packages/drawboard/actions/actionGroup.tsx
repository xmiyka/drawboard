...
import { KEYS, randomId, arrayToMap } from "@drawboard/common";
...
const allElementsInSameGroup = (elements: readonly DrawboardElement[]) => {
...
export const actionGroup = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    const lastGroupElementIndex = nextElements.lastIndexOf(
      lastElementInGroup as OrderedDrawboardElement,
    );
...
export const actionUngroup = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    const boundTextElementIds: DrawboardTextElement["id"][] = [];
    nextElements = nextElements.map((element) => {
    ...
    ).reduce((acc: { [key: DrawboardElement["id"]]: true }, [id, selected]) => {
