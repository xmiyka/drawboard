...
import { fixBindingsAfterDeletion } from "@drawboard/element";
...
const deleteSelectedElements = (
  ...
  const selectedElementIds: Record<DrawboardElement["id"], true> = {};

  const elementsMap = app.scene.getNonDeletedElementsMap();

  const processedElements = new Set<DrawboardElement["id"]>();
