...
import { bindOrUnbindBindingElement } from "@drawboard/element/binding";
import {
  isValidPolygon,
  LinearElementEditor,
  newElementWith,
...
import { isPathALoop } from "@drawboard/element";
...
export const actionFinalize = register<FormData>({
  ...
  perform: (elements, appState, data, app) => {
    ...
    let element: NonDeleted<DrawboardElement> | null = null;
    if (appState.multiElement) {
      ...
      ) as NonDeleted<DrawboardLinearElement> | undefined;
      if (candidate) {
        element = candidate;
      }
    }
