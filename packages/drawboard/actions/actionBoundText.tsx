...
import { syncMovedIndices } from "@drawboard/element";

import { newElement } from "@drawboard/element";
  ...
  perform: (elements, appState, _, app) => {
    ...
    selectedElements.forEach((element) => {
      ...
      if (boundTextElement) {
        ...
        app.scene.mutateElement(boundTextElement as DrawboardTextElement, {
          containerId: null,
          width,
          height,
...
export const actionBindText = register({
  ...
  perform: (elements, appState, _, app) => {
    ...
    let container: DrawboardTextContainer;
    ...
    if (
      ...
      textElement = selectedElements[1] as DrawboardTextElement;
      container = selectedElements[0] as DrawboardTextContainer;
    }
...
export const actionWrapTextInContainer = register({
  ...
  perform: (elements, appState, _, app) => {
    const selectedElements = app.scene.getSelectedElements(appState);
    let updatedElements: readonly DrawboardElement[] = elements.slice();
