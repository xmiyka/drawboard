...
import { renderSelectionElement } from "@drawboard/element";
...
import type { TransformHandles, TransformHandleType } from "@drawboard/element";
...
const renderElementsBoxHighlight = (
  context: CanvasRenderingContext2D,
  appState: InteractiveCanvasAppState,
  elements: NonDeleted<DrawboardElement>[],
  ...
  const getSelectionFromElements = (elements: DrawboardElement[]) => {
...
const renderCropHandles = (
  ...
  renderConfig: InteractiveCanvasRenderConfig,
  appState: InteractiveCanvasAppState,
  croppingElement: DrawboardImageElement,
  elementsMap: ElementsMap,
): void => {
...
const renderTextBox = (
  text: NonDeleted<DrawboardTextElement>,
  context: CanvasRenderingContext2D,
  appState: InteractiveCanvasAppState,
...
const _renderInteractiveScene = ({
  ...
  let editingLinearElement: NonDeleted<DrawboardLinearElement> | undefined =
    undefined;
  ...
  visibleElements.forEach((element) => {
    ...
    if (
      ...
      if (element) {
        editingLinearElement = element as NonDeleted<DrawboardLinearElement>;
      }
    }
  });
  ...
  if (
    ...
    renderLinearPointHandles(
      context,
      appState,
      selectedElements[0] as NonDeleted<DrawboardLinearElement>,
      elementsMap,
    );
  }
  ...
  if (
    ...
    if (
      ...
      renderLinearPointHandles(
        context,
        appState,
        selectedElements[0] as DrawboardLinearElement,
        elementsMap,
      );
    }
