...
} from "@drawboard/drawboard/renderer/helpers";
import { type AppState } from "@drawboard/drawboard/types";
import { arrayToMap, throttleRAF } from "@drawboard/common";
...
import { isCurve } from "@drawboard/math/curve";
...
import type {
  DebugElement,
  DebugPolygon,
} from "@drawboard/element/visualdebug";
import type {
  ElementsMap,
  ...
  elements.forEach((element) => {
    ...
    if (isBindableElement(element) && element.boundElements?.length) {
      element.boundElements.forEach((boundElement) => {
        ...
        const arrow = elementsMap.get(boundElement.id) as DrawboardArrowElement;
