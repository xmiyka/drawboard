    ...
    build: {
      ...
      rollupOptions: {
        output: {
          ...
          manualChunks(id) {
            if (
              id.includes("packages/drawboard/locales") &&
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          name: "Drawboard",
          description:
            "Drawboard is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
          ...
          file_handlers: [
            {
              action: "/",
              accept: {
                "application/vnd.drawboard+json": [".drawboard"],
              },
            },
          ],
          share_target: {
              ...
              files: [
                {
                  name: "file",
                  accept: [
                    "application/vnd.drawboard+json",
                    "application/json",
                    ".drawboard",
                  ],
                },
