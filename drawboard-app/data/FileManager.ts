...
import { compressData } from "@drawboard/drawboard/data/encode";
...
export class FileManager {
  /** files being fetched */
  private fetchingFiles = new Map<DrawboardImageElement["fileId"], true>();
  private erroredFiles_fetch = new Map<DrawboardImageElement["fileId"], true>();
  /** files being saved */
  private savingFiles = new Map<DrawboardImageElement["fileId"], FileVersion>();
  /* files already saved to persistent storage */
  private savedFiles = new Map<DrawboardImageElement["fileId"], FileVersion>();
  private erroredFiles_save = new Map<
    DrawboardImageElement["fileId"],
    FileVersion
  >();
   ...
   */
  shouldPreventUnload = (elements: readonly DrawboardElement[]) => {
...
export const updateStaleImageStatuses = (params: {
  ...
  params.drawboardAPI.updateScene({
    elements: params.drawboardAPI
