import { CaptureUpdateAction, newElementWith } from "@drawboard/drawboard";
import {
  createRedoAction,
  createUndoAction,
} from "@drawboard/drawboard/actions/actionHistory";
import { syncInvalidIndices } from "@drawboard/element";
import { API } from "@drawboard/drawboard/tests/helpers/api";
import { act, render, waitFor } from "@drawboard/drawboard/tests/test-utils";
import { vi } from "vitest";

import { StoreIncrement } from "@drawboard/element";

import DrawboardApp from "../App";

import type { DurableIncrement, EphemeralIncrement } from "@drawboard/element";
...
vi.mock("../../drawboard-app/data/firebase.ts", () => {
